Shader "SHOL/Stylized Surface Fracturable"
{
    Properties
    {
        ...
        [HideInInspector]_FractureTextures("Fracture textures", 2DArray) = "" {}
    }
    
    SubShader
    {
        Tags { "RenderType"="Opaque" "Queue" = "Transparent+7" }
        LOD 200
        ...
        #include "../FlatKit/Shaders/StylizedSurface/DustyroomStylizedLighting.cginc"
        #pragma surface surfObject DustyroomStylized vertex:vertObject fullforwardshadows //tessellate:tessDist
        #pragma target 3.0
